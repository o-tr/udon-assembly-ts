...
describe("string / for-of / null-check regressions", () => {
  ...
  describe("Bug 1: string method/property return types resolve to SystemObject", () => {
    it("indexOf() without annotation produces SystemObject comparison", () => {
      const source = `
        class Main {
          Start(): void {
            const s: string = "mps";
    ...
    it("toUpperCase() without annotation produces SystemObject variable", () => {
      const source = `
        class Main {
          Start(): void {
    ...
    it("string.length without annotation produces SystemObject comparison", () => {
      const source = `
        class Main {
          Start(): void {
            const s: string = "hello";
    ...
    it("startsWith() without annotation produces SystemObject variable", () => {
      const source = `
        class Main {
          Start(): void {
            const s: string = "hello";
